---
title: "How should prior beliefs influence our conclusions from Moran et al. (2020)?"
output:
  html_document:
    code_folding: hide
    highlight: haddock
...
# Is the mind an iceberg or a puddle?

I recently had the opportunity to be involved in Moran, Hughes, Hussey, Valdilo, Olson, et al.'s (2020) Registered Replication Report. This was a replication of Olson & Fazio's (2001) study on attitude formation via stimulus pairing (Evalautive Conditioning) in the absence of awareness that stimuli had been paired. 

A bit of a mouthful, but a key motivator for me was that Olson & Fazio (2001) is (a) highly cited and influential upon later theoretical and empirical work, and yet (b) when you ask them informally, most researchers in the field say they doubt the effect would replicate. 

Why? 

Let's first take a step back to define the "Evaluative Conditioning" part of this study before we bring awareness into the equation. Typically, if you pair an initually neutral stimulus like the non-word "CUG" with a negatively valenced stimulus like "Cancer", CUG is later rated as more negative. This example forms the definition of Evaluative Conditioning (EC): changes in liking due to the prior pairing of stimuli (REF). I should note that there is nothing particularly controversial about the concept of EC - that comes later.

The question raised by Olson & Fazio (2001) is one that is at the center of many debates with the study of psychology, and represents two vastly different world views. 

One the one hand, maybe the human mind is relatively boring, and the participants in our EC studies dislike "CUG" follows the same definition of EC as the researcher used to create the study: "Well, you paired CUG with Cancer, and cancer is negative, so therefore CUG is negative." This is referred to as the Inferential Account of EC (REF). I like the linguistic sales pitch being done by the name of this account: it does a nice job of dressing up the fact that all it's saying is that your participants in EC studies possess the same reasoning ability as you the researcher do, and they 'solve' the puzzle presented by the study (i.e., pairings are usually a cue for 'sameness').

On the other hand, maybe the human mind is mysterious, deep and just plain cool. Maybe it's doing all sorts of calculations that we are unaware of and only letting our conscious mind in on some of it. Maybe you do have the hidden depth that your existential dread yearns for. More specifically, maybe there are participants who think "CUG" is now negative despite being unaware that it was ever paired with "Cancer". This would allow us to think and talk about things like "low level", and "automatic" "cognitive processes" that occur "outside of awareness", and other validations of what I have come to see as our collective need for quasi religious mystery in psychology. It is, as commentators in the 2015 US presidential campaign used to say, "Big, if true".  

Perhaps by this stage you have some idea of which camp I'm in.

At this point, as a reader, maybe its tempting to think that I am being biased here. I whole heartedly agree, and don't think this is a bad thing. 

Here's were the benefits of Bayesian statistics come in: prior beliefs - the lense through which we interpret new data - can be quantified; we can examine their impact on conclusions; and we can consider more than one. For example, we can formalize how a true believer in Unaware Evalautive Conditioning vs. a hardline skeptic should each interpret the results of Moran et al. (2020). 

This isn't attempt to be 'free of bias' - an idea that appeals to a false sense of attainable objectivity and scientism - but instead to explicate our prior beliefs and integreat them in our analysis. 

# Bayesian analysis and defining priors

The process of choosing priors is something many people initially find difficult when learning Bayesian analysis. 

Personally, I think a reasonable way to choose priors is to look to the existing published literature. This isn't to say that the published literature is unbiased - it almost definitely is, as multiple large scale repliation effects in the last few years have [shown us](https://www.frontiersin.org/articles/10.3389/fpsyg.2019.00813/full). Nonetheless, the literature gives us a starting point. 





The intuition here is relatively simple: 

many   and then ask people to rate the neutral stimulus, the people who say that the neutral stimulus has acquired a valence 

There were several features of this project that got me interested in it.


- The draft manuscript already contained a meta analysis of the published literature. 
...
- One of the original authors, Olson, was involved in the replication. 
- Both of the original authors agreed to approve the study protocol prior to registration and data collection.
- It was a multi-site replication with 12 different labs around the world. 
- The project provided me with novel challenges around making the materials and analyses maximally reproducible. 
