...
One the one hand, maybe the human mind is relatively boring, and the reason participants in our EC studies dislike "CUG" follows the same definition of EC as the researcher used to create the study: "Well, you paired CUG with Cancer, and cancer is negative, so therefore CUG is negative." This is referred to as the Inferential Account of EC (REF). I like the linguistic sales pitch being done by the name of this account: it does a nice job of dressing up the fact that all it's saying is that your participants in EC studies possess the same reasoning ability as you the researcher do, and they 'solve' the puzzle presented by the study (i.e., pairings are usually a cue for 'sameness').

On the other hand, maybe the human mind is mysterious, deep and just plain cool. Maybe it's doing all sorts of calculations that we are unaware of and only letting our conscious mind in on some of it. By implication, maybe you do have the hidden depth that your existential dread yearns for. More specifically, maybe there are participants who now think "CUG" is negative despite being unaware that it was ever paired with "Cancer". This would allow us to think and talk about things like "low level cognitive processes" that are "automatic" or "occur outside of awareness", or other validations of our collective need for quasi religious mystery in psychology. It is, as commentators in the 2015 US presidential campaign used to say, "Big, if true".  
...
This isn't attempt to be 'free of bias' - an idea that appeals to a false sense of attainable objectivity and scientism - but instead allows us to explicate our prior beliefs and integrate them into our analysis and conclusions. It also allows you to see the same data through the lens of others' beliefs.  
...
There was another key feature of this project that got me interested in it: the draft manuscript already contained a meta analysis of the published literature. 
...
Using compound exclusion criterion (Hussey & Hughes, 2020)
